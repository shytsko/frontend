        ...
        <article className="cart__item">
            ...
            <div className="cart__item-description">
                ...
                <p className="cart__item-text">
                    Price: <span className="highlighted">${product.price.toFixed(2)}</span>
                </p>
                <p className="cart__item-text">Color: {product.color}</p>
                <p className="cart__item-text">Size: {product.size}</p>
                <p className="cart__item-text">
                    Quantity:
                    <input
